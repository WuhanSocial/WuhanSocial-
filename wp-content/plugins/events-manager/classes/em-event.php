...
class EM_Event extends EM_Object{
	...
	// change by Anil
		if ( ! add_post_meta( $post_id, '_event_price', $_POST['event_price'], true ) ) { update_post_meta( $post_id, '_event_price', $_POST['event_price'] ); }
		
		if ( ! add_post_meta( $post_id, '_event_price_checkbox', $_POST['event_price_checkbox'], true ) ) { update_post_meta( $post_id, '_event_price_checkbox', $_POST['event_price_checkbox'] ); }
		// end change
