...
class EM_Location extends EM_Object {
	...
	var $location_latitude = 30.579845;
	var $location_longitude = 114.290725;	var $post_content = '';
	var $location_owner = '';
	...
	function __construct($id = false,  $search_by = 'location_id' ) {
		global $wpdb;
		//Initialize
		$this->required_fields = array("location_address" => __('The location address', 'events-manager'));
