...
<form enctype='multipart/form-data' id="event-form" method="post" action="<?php echo esc_url(add_query_arg(array('success'=>null))); ?>">
	<div class="wrap">
		...
		<div class="inside event-form-name">
            ...
            <h3 class="event-form-submitter"><?php esc_html_e( 'Price', 'events-manager'); ?></h3>
			<div class="inside event-form-submitter">
				<p><input type="text" name="event_price" id="event_price"  style="max-width:250px" value="<?php echo esc_attr($EM_Event->event_price); ?>" />&yen;<br />
				Check this box if Free: <input type="checkbox" name="event_price_checkbox" id="event_price_checkbox" value="1" /></p>
