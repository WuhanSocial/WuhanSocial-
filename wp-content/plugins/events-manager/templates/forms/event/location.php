	...
	<table class="em-location-data">
		...
		<tr class="em-location-data-name">
			...
			<td>
				...
				<br />
				<em id="em-location-search-tip"><?php esc_html_e( 'Name of bar/restaurant/club/hotel where your event will take a place.', 'events-manager')?></em>
		...
		<tr class="em-location-data-address">
			...
			<td>
				<input id="location-address" type="text" name="location_address" value="<?php echo esc_attr($EM_Location->location_address); ; ?>" /><?php echo $required; ?>
                        ...
                        <br />  
                        <em id="em-location-search-tip"><?php esc_html_e( 'Chinese Address for Taxi Driver', 'events-manager')?></em>  

			</td>
		</tr>
		<tr class="em-location-data-town">
			<th><?php _e ( 'Location Details:', 'events-manager')?>&nbsp;</th>
			<td>
				<input id="location-town" type="text" name="location_town" value="<?php echo esc_attr($EM_Location->location_town); ?>" /><?php echo $required; ?>

                        <br />  
                        <em id="em-location-search-tip"><?php esc_html_e( 'Pinyin or English Description', 'events-manager')?></em>

			</td>
		</tr>		
		
		<tr class="em-location-data-region">
			<th><?php _e ( 'Wuhan Social Places URL:', 'events-manager')?>&nbsp;</th>
			<td>
