    ...
    <div class="td-video-template-bg">
        <div class="td-container">
            <div class="td-pb-row">
                ...
                <div class="td-pb-span4 td-post-header padnone">
                    ...
                    <header class="td-post-title">
						...
						<?php 
						echo EM_Events::output(array('post_id'=>$td_mod_single->post->ID, 'limit'=>1, 'format'=>' 
								       	
							
                        <ul class="eventinfo">
						<li>#_CATEGORIES</li>
		
<li><i class="fa fa-at"></i>#_LOCATIONLINK</li>
				
                        <li><i class="fa fa-calendar-o"></i>#_EVENTDATES</li>						
						<li><i class="fa fa-clock-o"></i>#_EVENTTIMES</li>
						...
						'));
						?>					 
<li><span class="priceinfo"><?php
if(get_post_meta($td_mod_single->post->ID,'_event_price_checkbox',true )){
	echo "FREE";
}else{
	echo get_post_meta($td_mod_single->post->ID,'_event_price',true ).'<i class="fa fa-jpy"></i>';
}?>
</span></li>
                    ...
                    ?>
                        ...
                        <div class="td-pb-span4 td-main-sidebar" role="complementary">
                            <div class="td-ss-main-sidebar">
                                <?php if ( is_active_sidebar( 'td-event-page-custom-sidebar' ) ) { 
                                dynamic_sidebar( 'td-event-page-custom-sidebar' ); 
								}else{ get_sidebar(); }?>
                            </div>
                        </div>
                    <?php
